...
class DLRM_Net(nn.Module):
	...
	def mixed_forward(self, dense_x, lS_o, lS_i):	
		...
		#begin_mlp_repl = time_wrap(use_gpu)
		...
		#end_mlp_repl = time_wrap(use_gpu)
		
		#if should_print:
		#	print("MLP_Repl ", 1000*(end_mlp_repl - begin_mlp_repl))

		#begin_dense_ip_scat = time_wrap(use_gpu)
		### prepare input (overwrite) ###
		# scatter dense features (data parallelism)
		# print(dense_x.device)
		dense_x = scatter(dense_x, device_ids, dim=0)

		#end_dense_ip_scat = time_wrap(use_gpu)

		#if should_print:
		#	print("Dense_Ip_Scatter ", 1000*(end_dense_ip_scat - begin_dense_ip_scat))

		#begin_bot_mlp = time_wrap(use_gpu)

		x = parallel_apply(self.bot_l_replicas, dense_x, None, device_ids)

		#end_bot_mlp = time_wrap(use_gpu)
		
		#if should_print:
		#	print("Bot_MLP ", 1000*(end_bot_mlp - begin_bot_mlp))

		#begin_apply_emb = time_wrap(use_gpu)
		...
		#end_apply_emb = time_wrap(use_gpu)
		
		#if should_print:
		#	print("Apply_EMB ", 1000*(end_apply_emb - begin_apply_emb))

		#begin_emb_dist = time_wrap(use_gpu)
		...
		#end_emb_dist = time_wrap(use_gpu)
		...
		#begin_feature_int = time_wrap(use_gpu)
		# interactions
		z = []
		...
		# debug prints
		# print(z)
		#end_feature_int = time_wrap(use_gpu)

		#if should_print:
		#	print("Feature_Int ", 1000*(end_feature_int - begin_feature_int))

		#begin_top_mlp = time_wrap(use_gpu)
		# top mlp
		...
		#end_top_mlp = time_wrap(use_gpu)

		#if should_print:
		#	print("Top_MLP ", 1000*(end_top_mlp - begin_top_mlp))

		#begin_gather = time_wrap(use_gpu)
		### gather the distributed results ###
		p0 = gather(p, self.output_d, dim=0)

		#end_gather = time_wrap(use_gpu)
		
		#if should_print:
		#	print("Gather_CTR ", 1000*(end_gather - begin_gather))
