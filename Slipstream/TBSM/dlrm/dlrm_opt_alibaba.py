...
class DLRM_Net(nn.Module):
	...
	def forward(self, dense_x, lS_o, lS_i, data, j):
	...
	def parallel_forward(self, dense_x, lS_o, lS_i, j):
		...
		"""t_list = []
		i_list = []
		for k, _ in enumerate(self.hot_emb_l):
...
if __name__ == "__main__":
	...
	if use_gpu:
		...
		print("Running DLRM Optimization")
	...
	if (args.data_generation == "dataset"):
		...
		test_ld = dp.load_test_data_and_loaders(args)
		# =================================================================================================
	...
	with torch.autograd.profiler.profile(args.enable_profiling, use_gpu) as prof:
		while k < args.nepochs:
			...
			for i, emb_dict in enumerate(hot_emb_dict):
				for j, (emb_no, emb_row) in enumerate(emb_dict):
