...
def load_test_data_and_loaders(args):
    ...
    test_loader = torch.utils.data.DataLoader(
            ...
            collate_fn=collate_wrapper_criteo,
            pin_memory=False,
            drop_last=False,  # True -- yass
        )

    return test_loader

def load_criteo_preprocessed_data_and_loaders(args, train_hot, train_normal):
#def load_criteo_preprocessed_data_and_loaders(args,  train_normal): 
    ...
    train_hot_loader = torch.utils.data.DataLoader(
        ...
        num_workers=args.num_workers,
        collate_fn=collate_wrapper_criteo,
        pin_memory=True, # used to be false
        drop_last=True,  # True -- yass
    )
...
def load_criteo_preprocessed_data_and_loaders_one(args,  train_hot): 
